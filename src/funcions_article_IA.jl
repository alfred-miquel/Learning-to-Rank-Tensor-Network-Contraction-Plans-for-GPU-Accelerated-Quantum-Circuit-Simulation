...
"""
function contract_pair_rank!(f::IO,tn::TensorNetwork, a_sym::Symbol, b_sym::Symbol, c_sym::Symbol=:_;
    ...
    #println("Anem a contractar $a_sym amb rang $(a.rank) i $b_sym amb rang $(b.rank)")
   # println("Els indexs comuns són :  $common_indices")
    ...
    #println("Després de la contracció el rang del producte o resultat és $c_sym amb rang $(tn.:tensor_map[c_sym].rank)")
    #push!(Dades,(a_sym,b_sym,c_sym,tn.:tensor_map[a_sym].rank,tn.:tensor_map[b_sym].rank,tn.:tensor_map[c_sym].rank,common_indices))
      if verbose
